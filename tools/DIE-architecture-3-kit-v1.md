...
REVISION HISTORY
----------------
v1.0 (2026-06-05, commit de3a541): Initial release.
v1.0 (2026-06-06, this commit):    Corrigendum. Component B refreshed from
                                   stale program.md v1.3 content to
...
Component B — program.md v1.4 (commit 1ff0af5, May 2026)
              ...
              §10 Adversarial Test (8 attacks with required
              answers).
              Operational sections (Score Function, Supervisor
              Outreach, Rules of Engagement, Work Queue,
              Amendment Log, North Star) omitted to preserve
              token budget — see full program.md on GitHub if
              needed.
...
TOKEN BUDGET
------------
~19,600 tokens for the full kit (cl100k_base).
...
## 2. THE FOUR VALIDATION CONDITIONS
...
~19,600 tokens. Other tokenizers (Claude, Gemini,
